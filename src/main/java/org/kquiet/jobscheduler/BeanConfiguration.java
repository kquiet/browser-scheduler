...
public class BeanConfiguration {
  ...
  public JobSchedulerConfig getJobSchedulerConfig() {
    return new JobSchedulerConfig();
  }

  @Bean(destroyMethod = "stop")
  @Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
  public JobController getController(JobSchedulerConfig config) {
    return new JobController(config);
  }

  @Bean(destroyMethod = "stop")
  @Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
  public MonitorFrame getMonitorFrame(JobSchedulerConfig config) {
