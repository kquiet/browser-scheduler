...
/**
 * This class is the base of all jobs. Each job class should extend this class and provide their own
 * implementation.
 *
 * @author Kimberly
 */
public abstract class JobBase implements Runnable {
   ...
   */
  public JobBase(JobConfig config) {
  ...
  public final String getParameter(String name) {
    Map<String, String> parameter = getJobConfig().getParameters();
    if (parameter != null) {
  ...
  /**
   * Pause the execution of internal browser. All executing browser tasks will remain running until
   * they complete.
   */
